...
//
const BotName = 'P4TR1CK'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/itsmegaragong'; // Nama Instagramlu cok
const whatsapplu = '085840200544'; // Nomor whatsapplu cok
const kapanbotaktif = 'JIKA ADA KUOTA'; // Kapan bot lu aktif
const grupch1 = 'BLM BUAT'; // OFFICIAL GRUP LU 1
const grupch2 = 'BLM BUAT'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
